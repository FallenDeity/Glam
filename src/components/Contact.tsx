export default function ContactForm(): React.JSX.Element {
	return (
		<section
			className="wave-section mt-5 bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 px-8 py-12 text-gray-100"
			id="contact">
			<div className="air air1 top-0 rotate-180"></div>
			<div className="air air2 top-0 rotate-180"></div>
			<div className="air air3 top-0 rotate-180"></div>
			<div className="air air4 top-0 rotate-180"></div>
					...
					<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<g id="Desktop-HD" transform="translate(-1112.000000, -438.000000)">
							<g id="logo-4" transform="translate(1112.000000, 438.000000)">
								...
								<polygon
									id="Fill-79"
									points="149.674276 5.91365238 149.674276 0.846938095 130.25278 0.846938095 130.25278 27.8825333 149.674276 27.8825333 149.674276 22.815819 136.095771 22.815819 136.095771 16.6954381 149.386192 16.6954381 149.386192 11.6287238 136.095771 11.6287238 136.095771 5.91365238"></polygon>
							</g>
						</g>
					</g>
				</svg>
			...
			<div className="mx-auto mt-24 grid max-w-screen-xl grid-cols-1 gap-8 rounded-lg bg-gray-100 px-8 py-16 text-gray-900 shadow-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
				...
				<div className="">
					<div>
						<span className="text-sm font-bold uppercase text-gray-600">Full Name</span>
						<input
